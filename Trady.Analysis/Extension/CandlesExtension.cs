...
namespace Trady.Analysis.Extension
{
    public static class IOhlcvDatasExtension
    {
        ...
        public static IReadOnlyList<IAnalyzableTick<decimal?>> Func(this IEnumerable<IOhlcvData> candles, string name, params decimal[] parameters)
        ...
        public static IReadOnlyList<AnalyzableTick<decimal?>> Mtm(this IEnumerable<IOhlcvData> candles, int? startIndex = null, int? endIndex = null)
            => new Momentum(candles).Compute(startIndex, endIndex);

        public static IReadOnlyList<AnalyzableTick<decimal?>> Mtm(this IEnumerable<IOhlcvData> candles, int numberOfDays, int? startIndex = null, int? endIndex = null)
            => new Momentum(candles, numberOfDays).Compute(startIndex, endIndex);

        public static IReadOnlyList<AnalyzableTick<decimal?>> Roc(this IEnumerable<IOhlcvData> candles, int? startIndex = null, int? endIndex = null)
            => new RateOfChange(candles).Compute(startIndex, endIndex);

        public static IReadOnlyList<AnalyzableTick<decimal?>> Roc(this IEnumerable<IOhlcvData> candles, int numberOfDays, int? startIndex = null, int? endIndex = null)

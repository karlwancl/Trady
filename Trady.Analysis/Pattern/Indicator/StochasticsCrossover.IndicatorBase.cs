...
namespace Trady.Analysis.Pattern.Indicator
{
    public partial class StochasticsCrossover
    {
        ...
        {
            private readonly AnalyzableBase<(decimal High, decimal Low, decimal Close), (decimal High, decimal Low, decimal Close), (decimal? K, decimal? D, decimal? J), (decimal? K, decimal? D, decimal? J)> _sto;
            ...
            protected override Crossover? ComputeByIndexImpl(IReadOnlyList<(decimal High, decimal Low, decimal Close)> mappedInputs, int index)
            {
                if (index < 1)
                    return null;

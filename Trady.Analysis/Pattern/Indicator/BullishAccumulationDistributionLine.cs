...
{
    public class BullishAccumulationDistributionLine : PatternBase<NonDirectionalPatternResult>
    {
        private AccumulationDistributionLine _accumDistIndicator;

        public BullishAccumulationDistributionLine(Equity series) : base(series)
        {

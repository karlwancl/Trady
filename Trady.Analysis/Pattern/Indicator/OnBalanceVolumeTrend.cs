...
namespace Trady.Analysis.Pattern.Indicator
{
    ...
    {
        private readonly OnBalanceVolumeByTuple _obv;
        ...
        protected override Trend? ComputeByIndexImpl(IReadOnlyList<(decimal Close, decimal Volume)> mappedInputs, int index)

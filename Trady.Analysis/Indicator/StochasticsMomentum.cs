...
namespace Trady.Analysis.Indicator
{
    ...
    public class StochasticsMomentum : StochasticsMomentum<IOhlcvData, AnalyzableTick<decimal?>>
    {
        public StochasticsMomentum(IEnumerable<IOhlcvData> inputs, int periodCount) 

...
namespace Trady.Analysis.Indicator
{
    public class ChandelierExit<TInput, TOutput> : AnalyzableBase<TInput, (decimal High, decimal Low, decimal Close), (decimal? Long, decimal? Short), TOutput>
    {
        ...
        public ChandelierExit(IEnumerable<TInput> inputs, Func<TInput, (decimal High, decimal Low, decimal Close)> inputMapper, Func<TInput, (decimal? Long, decimal? Short), TOutput> outputMapper, int periodCount, int atrCount) : base(inputs, inputMapper, outputMapper)
        {
    ...
    {
        public ChandelierExitByTuple(IEnumerable<(decimal High, decimal Low, decimal Close)> inputs, int periodCount, int atrCount) 
    ...
    {
        public ChandelierExit(IEnumerable<Candle> inputs, int periodCount, int atrCount) 

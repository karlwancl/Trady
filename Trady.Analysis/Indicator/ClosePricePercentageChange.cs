...
namespace Trady.Analysis.Indicator
{
    ...
    {
        public ClosePricePercentageChange(IEnumerable<TInput> inputs, Func<TInput, decimal> inputMapper, Func<TInput, decimal?, TOutput> outputMapper, int numberOfDays = 1) : base(inputs, inputMapper, outputMapper)
        {
